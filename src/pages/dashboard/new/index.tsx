...
export function New() {
  ...
  async function handleDeleteImage(item: ImageItemProps) {
    ...
    try {
      ...
      toast.error("Erro ao deletar, informe ao adm!");
    }
  }
  ...
  return (
    <Container>
      ...
      <div className="w-fuull bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2">
        ...
        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-3">
            ...
            <Input
              ...
              placeholder="Ex: 1.0 gasolina comum manual.."
            />
          </div>
          ...
          <div className="flex w-full mb-3 flex-row items-center gap-4">
            <div className="w-full">
              ...
              <Input
                ...
                placeholder="Ex: código do país, código operadora e numero"
              />
            </div>
